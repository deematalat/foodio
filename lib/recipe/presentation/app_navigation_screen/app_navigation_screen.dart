...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapPhoneRegistration(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapFavoritesFoodItems(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapVefificationCode(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.vefificationCodeScreen);
  }

  onTapRessetPassword(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.ressetPasswordScreen);
  }

  onTapPhoneRegistration(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.phoneRegistrationScreen);
  }

  onTapSideMenu(BuildContext context) {
  ...
  onTapFoodDetails(BuildContext context) {
  ...
  onTapFavoritesFoodItems(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.favoritesFoodItemsScreen);
  }
  ...
  onTapRating(BuildContext context) {
